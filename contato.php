    ...
    include('conexao.php');
      try
      {
        ...
        if(isset($_POST["boto"]))
        {
          ...
          $query = "insert into contato (nome, email, telefone, celular, obs) values (:nome, :email, :telefone, :Celular, :Obs)";
          ...
          <div class="rd-navbar-main">
            <div class="rd-navbar-nav-wrap">
              ...
              <ul class="rd-navbar-nav">
                ...
                <li class="rd-nav-item"><a class="rd-nav-link" href="#">Notícias</a></li>
                <li class="rd-nav-item"><a class="rd-nav-link" href="carteirinha_virtual.html">Carteirinha Virtual</a></li>
                <li class="rd-nav-item active"><a class="rd-nav-link" href="contato.html">Contato</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <p>Preencha o formulário abaixo com os seus dados que o mais breve possível entraremos em contato. Caso prefira, entre em contato através do telefone: (14) 3879-5313.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="box p-3">
            <form method="post">
              ...
              <div class="form-group">
								...
								<textarea name="obs" class="form-control" rows="4" id="obs"></textarea>
							</div>
              <div class="form-group">
              <button class="btn btn-success" style="color: #fff; background-color: #107050;" name="boto" id="boto">Enviar</button>
              </div>
            </form>
          </div>
        </div>
